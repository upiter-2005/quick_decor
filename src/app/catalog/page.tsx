  ...
  return (
    <>
      ...
      <DataBlock title="AIR" redTitle="Ferrara Paint TM" reverse={false} image={air}>
        ...
        <div className='w-full mt-7 text-center'><RedButton linkText='Перейти в каталог' text='Перейти в каталог' href='/product/air-white' className='px-8' /></div>
      </DataBlock>
      ...
      <DataBlock title="Sand" redTitle="Як купити" reverse={true} image={sand}>
        ...
        <div className='w-full mt-7 text-center'><RedButton linkText='Перейти в каталог' text='Перейти в каталог' href='/product/sand-cool' className='px-8' /></div>
      </DataBlock>
      ...
      <DataBlock title="Microcement" redTitle="Ferrara Paint TM" reverse={false} image={cement}>
        ...
        <div className='w-full mt-7 text-center'><RedButton linkText='Перейти в каталог' text='Перейти в каталог' href='/product/microcemente-ash' className='px-8' /></div>
      </DataBlock>
      ...
      <DataBlock title="Travertine" redTitle="Як купити" reverse={true} image={travertin}>
        ...
        <div className='w-full mt-7 text-center'><RedButton linkText='Перейти в каталог' text='Перейти в каталог' href='/product/travertine-naturale' className='px-8' /></div>
      </DataBlock>
      ...
      <DataBlock title="Quick" redTitle="Ferrara Paint TM" reverse={false} image={quick}>
        ...
        <p><strong>Рекомендації щодо особливостей застосування:</strong> Є екологічно чистим покриттям. Має європейський сертифікат стандарту якості. Не має протипоказань, щодо використання в приміщеннях де знаходяться діти, або в приміщеннях для людей із алергією. Використовують зазвичай в будь-яких внутрішніх приміщеннях, які можуть піддаватися вологому прибиранню, навіть з використанням рідких, неагресивних побутових миючих засобів. Має помірну стійкість до ударів, подряпин або помірних механічних впливів (якщо вплив такої сили, що не руйнує шар базової шпаклівки). Рекомендується для оздоблення фасадів. </p>
        <div className='w-full mt-7 text-center'><RedButton linkText='Перейти в каталог' text='Перейти в каталог' href='/product/quick-concrete' className='px-8' /></div>
      </DataBlock>
      <Divider />
