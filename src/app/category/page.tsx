...
export default function Category() {
  return (
    <>
      ...
      <Divider />
      <VideoImage image={a1} />
      <DataBlock title="AIR" redTitle="Ferrara Paint TM" reverse={false} image={air}>
      ...
      <VideoImage image={a2} />
      <DataBlock title="Sand" redTitle="Як купити" reverse={true} image={sand}>
        ...
        <p><strong>Рекомендації щодо особливостей застосування:</strong> Є екологічно чистим покриттям. Має європейський сертифікат стандарту якості. Не має протипоказань, щодо використання в дитячих кімнатах, або в приміщеннях для людей із алергією. Використовують зазвичай в будь-яких сухих внутрішніх приміщеннях, що не потребують частого миття стін, або хімічної обробки. Покриття достатньо стійке до ударів, подряпин або помірних механічних впливів (якщо вплив такої сили, що не руйнує шар базової шпатлівки). Завдяки своїй шероховатій структурі має більшу здатність до накопичення пилу. Рекомендуємий догляд – сухе обезпилювання пилососом. Рекомендується помірне побутове навантаження.</p>
      ...
      <VideoImage image={a3} />
      <DataBlock title="Microcement" redTitle="Ferrara Paint TM" reverse={false} image={cement}>
      ...
      <VideoImage image={a4} />
      <DataBlock title="Travertine" redTitle="Як купити" reverse={true} image={travertin}>
        ...
        <p>Є екологічно чистим покриттям. Має європейський сертифікат стандарту якості. Не має протипоказань, щодо використання в приміщеннях де знаходяться діти, або в приміщеннях для людей із алергією. Використовують зазвичай в будь-яких внутрішніх приміщеннях, які можуть піддаватися вологому прибиранню, навіть з використанням рідких, неагресивних побутових миючих засобів. Має помірну стійкість до ударів, подряпин або помірних механічних впливів (якщо вплив такої сили, що не руйнує шар базової шпатлівки). Рекомендується для оздоблення фасадів</p>
      ...
      <VideoImage image={a5} />
      <DataBlock title="Quick" redTitle="Ferrara Paint TM" reverse={false} image={quick}>
        <p><strong>Зовнішній вигляд: </strong> покриття має ефект дизайнерського бетону. Зазвичай використовують в сучасних, лофт або змішаних дизайнерських стилях. Для визначення ефекту в широкому розумінні використовують поняття мікроцемент. Має сучасний зовнішній вигляд, та є трендовим покриттям в більшості європейських країн світу. Може використовуватися в різних внутрішніх приміщеннях. А також в санвузлах, та в місцях, де є незначне попадання води (окрім душових кабін та поверхонь з навантаженням великої кількості води).</p>
        <p> Є екологічно чистим покриттям. Має європейський сертифікат стандарту якості. Не має протипоказань, щодо використання в дитячих кімнатах, або в приміщеннях для людей із алергією. Використовують зазвичай в будь-яких внутрішніх приміщеннях, які можуть піддаватися вологому прибиранню, навіть з використанням рідких, неагресивних побутових миючих засобів. Завдяки своїй гладенькій структурі має незначну здатність до накопичення пилу. Слабо стійка до механічних пошкоджень та подряпин. Рекомендується помірне побутове навантаження.</p>
