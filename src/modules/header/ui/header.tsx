...
export const Header:React.FC<IHeaderProps> = ({className}) => { 
    return (
        <header className={cn(className, "w-full max-w-[1225px] mx-auto pt-3 pb-1 flex items-center justify-between md:gap-6 px-3 md:px-0")}>
            ...
            <div className="flex gap-1 items-center">
                ...
                <div className="ml-5">
                    <button className="flex items-center gap-3 text-[#9B9DA2] font-bold text-sm">
                        ...
                        <span className="hidden md:block">0 грн</span>
                    </button>
                </div>
            </div>
            <MobMenu />
