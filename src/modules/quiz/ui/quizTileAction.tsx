...
export const QuizTileAction:React.FC<IQuizTileAction> = ({className, text, image, slug, quizAction, current}) => {
    ...
    return(
        <button className={cn(`${current === slug ? `bg-[#ece0c7]`: `bg-white`} flex flex-col items-center justify-start gap-5  px-4 md:px-[30px] py-5 max-w-[165px] md:max-w-[267px] w-full h-[170px] md:h-[202px] custom-shadow hover:scale-105 transition-all mb-9 rounded-[10px]`, className)}
