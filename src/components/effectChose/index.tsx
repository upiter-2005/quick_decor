...
import demo from "@/shared/assets/images/demo1.png"
import demo2 from "@/shared/assets/images/demo2.png"
import demo3 from "@/shared/assets/images/demo3.png"
  ...
  return (
    <>
      ...
      <div className='max-w-[1144px] w-full m-auto flex flex-wrap justify-center gap-8 md:gap-[95px] mb-[55px] px-3 md:px-0' >
          <Link href="#" className='block w-[80px] h-[80px] relative overflow-hidden md:w-[133px] md:h-[133px] text-center hover:opacity-75 transition-all'>
            <Image src={demo}  fill objectFit='cover'  alt="quickdecor" className='rounded-[10px]' />
            <p className='text-main mt-5 md:mt-8 text-sm md:text-2xl font-medium'>Вітальня</p>
          </Link>
          <Link href="#" className='block w-[80px] h-[80px] relative overflow-hidden md:w-[133px] md:h-[133px] text-center hover:opacity-75 transition-all'>
            <Image src={demo2}  fill objectFit='cover'  alt="quickdecor" className='rounded-[10px]' />
          ...
          <Link href="#" className='block w-[80px] h-[80px] relative overflow-hidden md:w-[133px] md:h-[133px] text-center hover:opacity-75 transition-all'>
            <Image src={demo3}  fill objectFit='cover'  alt="quickdecor" className='rounded-[10px]' />
