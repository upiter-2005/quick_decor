    ...
    return (
        <nav className={cn('', className)}>
            <ul className=" flex justify-between items-center gap-6 text-gray font-medium text-sm">
                <li className="py-7"><a href="/catalog" >Каталог</a></li>
                ...
                <li className="py-7"><Link href="/cart" >Розрахувати вартість</Link></li>
                <li className="py-7"><Link href="/quiz" >Фільтр помічник</Link></li>
