...
export const Footer:React.FC = () => {
    return (
        <div className="bg-[#1C293F] pt-12 pb-4">
            <div className="flex justify-center"><Image src={logo} alt='quickdecor' /></div>
            ...
            <div className="flex justify-center items-start max-w-[1044px] w-full pt-6 m-auto gap-12">
            ...
            <div className="flex items-start justify-between max-w-[1144px] w-full pt-8 m-auto gap-12 text-white opacity-50 text-sm">
